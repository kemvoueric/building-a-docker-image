...
echo this server will run the inventory of your server 
sleep 2
...
PHY1=$(echo $'\e[1;33m'$PHY$'\e[0m')
      ...
      if 
         [[  $PHY == GmbH  ]]
         then 
         echo  we run some tests and found this $PHY1 , therefore the system is virtual 
         else 
         echo  we run some tests and found this $PHYC1, therefore the system is Physical 
         fi
echo
sleep 3
